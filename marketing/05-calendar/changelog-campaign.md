...
| F3 | **Prompt mode** (0.9.31/35) | Ta dictée brouillonne → prompt propre pour Cursor / Claude Code | Panneau Coding/Prompt |
...
| F7 | **On-device / bring your own AI** (0.9.4 relay) | Le plan tourne sur TON Claude, ton audio ne quitte jamais le Mac | Panneau engine/local |
| F8 | **Your data, under your control** (0.2.1→0.3.8) | Off-switch historique, auto-delete 7/30/90j, efface tout le cloud | Panneau History controls |
