...
|---|---|---|---|---|
| **P1** | **Voice-driven coding** (le wedge) | « dicter à Claude Code/Cursor », vibe-coding vocal | Both | Coding mode (Opus) + réutilise l'abo Claude (sans clé) |
| **P2** | **Dictée privée on-device** | « local voice-to-text Mac », « mon app upload-t-elle mon audio ? » | Searchable | Whisper/Parakeet on-device, audio jamais uploadé, Keychain |
| **P3** | **BYO-AI / no markup** | « utiliser mon abo Claude sans clé », « stop AI markups » | Shareable | BYOK : Claude Code / Anthropic / OpenRouter / Ollama |
...
- **P1 hub :** « How to code by voice with AI (the 2026 setup) » → spokes : dictate prompts to Claude Code (no key) · voice-to-text for Cursor · 20-min ramble → clean PR · hands-free coding · *(shareable)* « I dictated for a week instead of typing ».
...
- **P3 hub :** « Bring your own AI: stop paying a markup on dictation » → *(shareable)* « You're paying twice for AI. Here's the math. » · use your Claude Code sub (no key) · Anthropic vs OpenRouter vs Ollama · run fully local (Parakeet + Ollama).
