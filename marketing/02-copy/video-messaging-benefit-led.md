...
- **Social** : un builder qui ship vite, maître de ses outils.
...
## 6. Structure = PAS (marché problem-aware) → hook > clarté > preuve > CTA
- **Problem** : tu penses plus vite que tu tapes.
- **Agitate** : toute la journée tu traduis des idées en frappes ; ton flow casse, tes mains fatiguent.
- **Solve** : Verba inverse. Tu parles, texte propre au curseur, et ça peut faire la tâche.
- **Proof / anti-anxiété** : ta voix ne quitte jamais ton Mac ; rien sans ta confirmation ; avec l'IA que tu paies déjà.
- **CTA** (bénéfice) : arrête de taper, parle. Verba. verba.run.

## 7. SCRIPT VOIX OFF (EN, benefit-led, ~24s, zéro em dash, zéro jargon moteur)
> "You think faster than you type.
> So all day, you turn ideas into keystrokes. Your flow breaks, your hands get tired.
> Verba flips it. You talk, and clean text lands right where your cursor is.
> It can even do the task for you.
> Your voice never leaves your Mac. And nothing happens until you confirm.
> Stop typing. Start talking. Verba."

## 8. À tester (hypothèse falsifiable)
Hook douleur « You think faster than you type » vs hook produit « Speak it. Send it clean. » → mesurer la rétention 3s / le taux de complétion sur X/Reels. Signal : +X% de rétention 3s pour le hook-douleur = le problem-aware répond mieux à la douleur qu'au slogan produit.

## Garde-fous copy (opérateur) : anglais, zéro em dash, claims exacts (« audio never leaves your Mac », Confirm visible), pas de pricing chiffré en organique, pas de « Composio ».
